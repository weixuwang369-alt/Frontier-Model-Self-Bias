...
class Pipeline:
    def __init__(
        ...
        *,
        ...
        self.config = config
        # Per-run dirs isolate this run's artifacts; cache/manifests/reports stay shared.
        self.paths: DataPaths = default_data_paths(data_root, run_id=config.run_id()).ensure()
